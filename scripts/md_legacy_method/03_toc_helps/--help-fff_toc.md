...
--avoid-crossing-perimeters-max-detour N
 ...
 --only-one-perimeter-first-layer
                     Use only one perimeter on the first layer.
 ...
 --top-one-perimeter-type
                     Use only one perimeter on flat top surface, to give more space to the top infill
                     pattern. Could be applied on topmost surface or all top surfaces. (none, top,
                     topmost; default: none)
 --top-solid-layers N
